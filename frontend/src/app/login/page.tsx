            ...
            >
                <div className="glass-panel p-10 rounded-3xl shadow-premium border border-white/5 space-y-8">
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-muted-foreground text-lg">Sign in to your expensive server</p>
                    </div>
                    ...
                    <div className="text-center pt-4">
                        <p className="text-muted-foreground">
                            New here?{' '}
                            <Link href="/register" className="text-foreground font-semibold hover:underline transition-all underline-offset-4">
                                Create an account
                            </Link>
                        </p>
                    </div>
